...
def normal_equation(x, y):
    tetas = np.linalg.pinv(x.transpose().dot(x)).dot(x.transpose().dot(y))
    return tetas



path = r'C:\Users\Sani\Desktop\Mega_Ni\E-FOLDER\COURSERA\Data Science\Machine Learning\Week2\machine-learning-ex1\machine-learning-ex1\ex1\ex1data2.txt'
data = getdata(path)
